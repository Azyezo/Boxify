...
const AddProduct = () => {
  ...
  const handleAddProduct = (e) => {
    ...
    addProduct({ name, price, imgURL, description, months, account }).then(() => {
    ...
    <div className="addProduct">
      ...
      <div className="relative flex flex-col justify-center items-center">
        <div className="mt-10 ">
          ...
          >
            <h4 className="font-semibold text-xl my-4">Add a Box</h4>
            ...
            <label htmlFor="3">Three Months</label>
              <input
                type="radio"
                className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full pl-10"
                id="3"
                ...
                required
              />
              <label htmlFor="6">Six Months</label>
              <input
                type="radio"
                className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full pl-10"
                id="6"
            ...
            <div className="relative flex w-full flex-wrap items-stretch justify-between items-center">
              ...
              <Button color="red" ripple="light" type="submit">
                Save Product
              </Button>
            </div>
          </form>
